# Delta for import-engine

New capability `import-engine` — merged into `openspec/specs/import-engine/spec.md` at archive.
...
- `in_progress → failed` (fatal/unrecoverable failure)
...
- `partial → failed` (resume hit a fatal error)
