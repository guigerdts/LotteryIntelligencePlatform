# Delta — Generator Output (`generator-output`)

**Change**: `winning-numbers-pipeline` · **Store**: `openspec` · **Date**: 2026-08-23
**Artifact**: delta spec — NEW capability (proposal S1). `openspec/specs/` has no generator capability today (`GEN-*` lives in code/tests only), so these ADDED requirements become the full capability spec at archive.
...
### Requirement: R1: R-legal-combo — Legality Enforced Pre-Persist With Explicit Codes
...
### Requirement: R2: R-superbalota-required — Reproducible SB From Historical Marginals
...
### Requirement: R3: R-combination-score — Non-Null Selection-Weighted Score
