# Delta — Mis Números Page (`mis-numeros-page`)

**Change**: `winning-numbers-pipeline` · **Store**: `openspec` · **Date**: 2026-08-23
**Artifact**: delta spec — NEW capability (proposal S3; the proposal lists `my-numbers-page` — the owner-instructed name `mis-numeros-page` governs this spec set). Replaces the raw Generator form (`frontend/src/pages/Generator.tsx`, routed in `App.tsx`) with `MyNumbers.tsx`; client/type extensions in `services/gen.ts` and `types/gen.ts`.
...
### Requirement: R1: R-one-cta — Single End-To-End Action
...
### Requirement: R2: R-stage-progress-ui — Chain Progress Rendering
...
### Requirement: R3: R-ticket-two-draws — Revancha Always Bundled
...
### Requirement: R4: R-default-count-5 — Default Combination Count
...
### Requirement: R5: R-prize-tier-reference — Eight Official Tiers Table
...
### Requirement: R6: R-honest-disclaimer — Randomness Disclaimer
